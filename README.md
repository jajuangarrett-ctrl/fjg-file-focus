...
- Mobile-safe startup: the folder view is attached to the sidebar for normal manual navigation, but it is not opened automatically and does not follow file-open events.
